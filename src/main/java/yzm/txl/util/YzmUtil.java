...
public class YzmUtil {
	 ...
	 * @throws Exception
	 */
	public static String convertPng2Base64(BufferedImage image) throws Exception {
	 ...
	 * @throws Exception
	 */
	public static String md5Digest(String yzm) {
		try{
			MessageDigest md = MessageDigest.getInstance("MD5");
			byte[] result = md.digest((md5_key+yzm.toLowerCase()).getBytes());
